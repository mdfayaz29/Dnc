    ...
    return (
        <div className="dashboard-container">
            <div className="dashboard-inner">
                <MainCard title="User" breadcrumbs={breadcrumbs}>
                    <div>
                        <Box sx={{ width: '100%' }}>
                            <Box>
                                <Tabs value={value} onChange={handleChange} aria-label="basic tabs example">
                                    <Tab style={{ color: 'darkblue' }} icon={<GroupIcon />} label="User" {...a11yProps(0)} />
                                    <Tab style={{ color: 'darkblue' }} icon={<PersonAddAlt1Icon />} label="Add User" {...a11yProps(1)} />
                                </Tabs>
                            </Box>
