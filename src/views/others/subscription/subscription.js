...
export default function Subscription() {
    ...
    const [currentTab, setCurrentTab] = React.useState('Subscription'); // Initialize with the default tab
    const handleChange = (event, newValue) => {
        ...
        switch (newValue) {
            case 0:
                ...
                break;
            case 1:
                setCurrentTab('Add Subscriptionr');
                break;
            default:
                setCurrentTab('Subscription'); // Default to 'User' if newValue is unexpected
                break;
        }
    };
    const breadcrumbs = (
    ...
    return (
        <div className="dashboard-container">
            <div className="dashboard-inner">
                <MainCard title="Subscription" breadcrumbs={breadcrumbs}>
                    <Box sx={{ width: '100%' }}>
                        <Box>
                        ...
                        <TabPanel value={value} index={0}>
                            <ListSub ludata={{ cbf: setValue }} />
                        </TabPanel>

                        {/* Add Gateway */}
                        <TabPanel value={value} index={1}>
                            <AddSub iudata={{ cbf: setValue }} />
                        </TabPanel>
